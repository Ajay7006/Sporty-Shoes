...
public class SportyShoesServiceImpl implements SportyShoesService{
	...
	public void init() {
		...
		PurchaseReport pr1 = new PurchaseReport(6,"Ajay","Running",d,"puma_runner:5,puma_trackracer:10");
		PurchaseReport pr2 = new PurchaseReport(7,"Anant","Cricket",d,"adidas_cricket:5,nike_cricket:10");
		PurchaseReport pr3 = new PurchaseReport(8,"Vikas","Basketball",d,"adidas_basketball:5,nike_basketball:10");
		PurchaseReport pr4 = new PurchaseReport(9,"Laxmi","Football",d,"adidas_football:5,nike_football:10");
		PurchaseReport pr5 = new PurchaseReport(10,"Anirudha","Badminton",d,"adidas_Badminton:10,nike_Badminton:10");
